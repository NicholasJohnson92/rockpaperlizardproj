...
namespace rockpapergame
{
    ...
    {//member variables
        ...
        public virtual void ReadGesutures(int choice1, int choice2)
        {
            ...
            {
                winCounter2++; Console.WriteLine(" Player 1 played " + glist[choice1].name + " Player 2 chose " +glist[choice2].name + " Player 2 won this round!!  Score is now " +
                 " Player 1 : " + winCounter1 + " Player 2 : " + winCounter2); Console.ReadLine();
            }

            else if (glist[choice1].name == "Rock" && glist[choice2].name == "Scissors")
            {
                winCounter1++; Console.WriteLine(" Player 1 played " + glist[choice1].name + " Player 2 chose " + glist[choice2].name + " Player 1 won this round!!  Score is now " +
                  " Player 1 : " + winCounter1 + " Player 2 : " + winCounter2); Console.ReadLine();
            }
